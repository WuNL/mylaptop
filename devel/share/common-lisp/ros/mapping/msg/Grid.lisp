...
(cl:defmethod proability-val ((m <Grid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:proability-val is deprecated.  Use mapping-msg:proability instead.")
  (proability m))

(cl:ensure-generic-function 'texture-val :lambda-list '(m))
(cl:defmethod texture-val ((m <Grid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:texture-val is deprecated.  Use mapping-msg:texture instead.")
  (texture m))
