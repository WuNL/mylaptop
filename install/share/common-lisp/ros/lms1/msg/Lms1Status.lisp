...
(cl:defmethod cl:initialize-instance :after ((m <Lms1Status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lms1Status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lms1-msg:<Lms1Status> is deprecated: use lms1-msg:Lms1Status instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Lms1Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lms1-msg:header-val is deprecated.  Use lms1-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'nLms1Status-val :lambda-list '(m))
(cl:defmethod nLms1Status-val ((m <Lms1Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lms1-msg:nLms1Status-val is deprecated.  Use lms1-msg:nLms1Status instead.")
  (nLms1Status m))

(cl:ensure-generic-function 'timeLms1-val :lambda-list '(m))
(cl:defmethod timeLms1-val ((m <Lms1Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lms1-msg:timeLms1-val is deprecated.  Use lms1-msg:timeLms1 instead.")
  (timeLms1 m))
