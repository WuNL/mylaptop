...
(cl:defclass <Map> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (map
    :reader map
    :initarg :map
    :type (cl:vector mapping-msg:Grid)
   :initform (cl:make-array 0 :element-type 'mapping-msg:Grid :initial-element (cl:make-instance 'mapping-msg:Grid))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Map>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Map)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mapping-msg:<Map> is deprecated: use mapping-msg:Map instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:header-val is deprecated.  Use mapping-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'nHalfSize-val :lambda-list '(m))
(cl:defmethod nHalfSize-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:nHalfSize-val is deprecated.  Use mapping-msg:nHalfSize instead.")
  (nHalfSize m))

(cl:ensure-generic-function 'fResolution-val :lambda-list '(m))
(cl:defmethod fResolution-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fResolution-val is deprecated.  Use mapping-msg:fResolution instead.")
  (fResolution m))

(cl:ensure-generic-function 'fCenterX-val :lambda-list '(m))
(cl:defmethod fCenterX-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fCenterX-val is deprecated.  Use mapping-msg:fCenterX instead.")
  (fCenterX m))

(cl:ensure-generic-function 'fCenterY-val :lambda-list '(m))
(cl:defmethod fCenterY-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fCenterY-val is deprecated.  Use mapping-msg:fCenterY instead.")
  (fCenterY m))

(cl:ensure-generic-function 'fMapMaxElevation-val :lambda-list '(m))
(cl:defmethod fMapMaxElevation-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fMapMaxElevation-val is deprecated.  Use mapping-msg:fMapMaxElevation instead.")
  (fMapMaxElevation m))

(cl:ensure-generic-function 'fMapMinElevation-val :lambda-list '(m))
(cl:defmethod fMapMinElevation-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fMapMinElevation-val is deprecated.  Use mapping-msg:fMapMinElevation instead.")
  (fMapMinElevation m))

(cl:ensure-generic-function 'flagImage-val :lambda-list '(m))
(cl:defmethod flagImage-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:flagImage-val is deprecated.  Use mapping-msg:flagImage instead.")
  (flagImage m))

(cl:ensure-generic-function 'fVehicleX-val :lambda-list '(m))
(cl:defmethod fVehicleX-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fVehicleX-val is deprecated.  Use mapping-msg:fVehicleX instead.")
  (fVehicleX m))

(cl:ensure-generic-function 'fVehicleY-val :lambda-list '(m))
(cl:defmethod fVehicleY-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fVehicleY-val is deprecated.  Use mapping-msg:fVehicleY instead.")
  (fVehicleY m))

(cl:ensure-generic-function 'fVehicleZ-val :lambda-list '(m))
(cl:defmethod fVehicleZ-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fVehicleZ-val is deprecated.  Use mapping-msg:fVehicleZ instead.")
  (fVehicleZ m))

(cl:ensure-generic-function 'fVehicleHeading-val :lambda-list '(m))
(cl:defmethod fVehicleHeading-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:fVehicleHeading-val is deprecated.  Use mapping-msg:fVehicleHeading instead.")
  (fVehicleHeading m))

(cl:ensure-generic-function 'map-val :lambda-list '(m))
(cl:defmethod map-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping-msg:map-val is deprecated.  Use mapping-msg:map instead.")
  (map m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Map>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'fMapMinElevation))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'flagImage)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Map>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'flagImage) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'map)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mapping-msg:Grid))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Map>)))
  ...
  "9e8667361a3a10ad8f58c076746b9d63")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Map)))
  "Returns md5sum for a message object of type 'Map"
  "9e8667361a3a10ad8f58c076746b9d63")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Map>))
  ...
  (cl:list 'Map
    ...
    (cl:cons ':flagImage (flagImage msg))
